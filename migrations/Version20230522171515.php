 ...
 */
final class Version20230522171515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, date DATE NOT NULL, auteur VARCHAR(255) NOT NULL, contenue VARCHAR(255) NOT NULL, phrase_acroche VARCHAR(255) NOT NULL, images VARCHAR(255) NOT NULL, tag VARCHAR(255) NOT NULL, titre_images VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
